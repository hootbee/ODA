        ...
        <PopupContent>
          ...
          <Section>
            ...
            <OrderedList>
              ...
              <li>
                챗봇이 찾아준 데이터의 '/자세히 [파일명]'을 요청하여 데이터를 더 깊게 확인할 수 있습니다.
              </li>
              <li>
                '/종합활용' 또는 '/활용 [원하는 방식/목적]'으로 특정 파일에 대한 활용 방안을 요청할 수 있습니다.
              </li>
              <li>
                '/자유 [원하는 방식/목적]'으로 챗봇과 자유로운 대화를 나눌 수 있습니다.
              </li>
              <li>
                '/데이터 확인'으로 데이터 파일을 미리보고 다운로드하거나 간단한 분석을 수행할 수 있습니다.
              </li>
              <li>
                '/데이터 시각화'로 선택된 데이터를 가장 적절한 그래프로 확인할 수 있습니다.
              </li>
              <li>
          ...
          <Section>
            ...
            <CommandList>
              ...
              <li>
                <code>/자세히 [파일명]</code> - 데이터의 상세 정보 확인
              </li>
              <li>
                <code>/종합 활용</code>, <code>/활용 [원하는 방식/목적]</code> - 데이터 활용 방안 확인
              </li>
              <li>
                <code>/자유 [원하는 방식/목적]</code> - AI와의 자유로운 대화
              </li>
              <li>
                <code>/데이터 확인</code> - 데이터 미리보기, 다운로드, 분석
              </li>
              <li>
                <code>/데이터 시각화</code> - 데이터에 적합한 그래프 추천 및 시각화
              </li>
              <li>
                <code>/다른 데이터</code> - 새로운 데이터 검색 시작
              </li>
            </CommandList>
          </Section>
        </PopupContent>
